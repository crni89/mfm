            ...
            <tr>
                ...
                <td>
                    <div className="btn-group" onClick={() => { doToggleAdministratorActiveState() }}>
                        ...
                        <div className={"btn btn-danger btn-sm" + inactiveSideClass}>
                            <FontAwesomeIcon icon={ faSquare } />
                        </div>
                    </div>
                </td>
                <td>
                    { !editPasswordVisible && <button className="btn btn-primary btn-sm" onClick={() => { setEditPasswordVisible(true); }}>Promena lozinke</button> }
                    ...
                    <button className="btn btn-danger btn-sm mx-3" onClick={ () => setDeleteRequested(true) }>Obrisi</button>
                    { deleteRequested && <ConfirmAction
                        title="Confirm that you want to delete this ingredient"
                        message={ "Are you sure that you want to delete this item: \"" + props.administrator.username + "\"?" }
